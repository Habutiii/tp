...
public class TypicalPersons {
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822234")
            .withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94824237")
